        ...
        <div class="theme-navigate">
            ...
            <div class="left">
                ...
                <div class="theme-navigate-user-panel">
                    <dl>
                        <dd>
                            <img src="${ctxstatic}/plugin/easyui/themes/insdep/images/user_img_default.png?v=20200522" width="86"
                                 height="86"
                                 onerror="javascript:this.src='${ctxstatic}/plugin/easyui/themes/insdep/images/user_img_default.png?v=20200522'">
            ...
            <div class="easyui-layout" data-options="border:false,fit:true">
                ...
                <div data-options="region:'north',border:false" style="height:100px;">
                    ...
                    <div class="theme-left-user-panel">
                        <dl>
                            <dt>
                                <img src="${ctxstatic}/plugin/easyui/themes/insdep/images/user_img_default.png?v=20200522" width="43"
                                     height="43"
                                     onerror="javascript:this.src='${ctxstatic}/plugin/easyui/themes/insdep/images/user_img_default.png?v=20200522'">
                            </dt>
                            <dd>
                                <b class="badge-prompt"><%--匿名--%>${user.username} <%--<i
                                        class="badge color-important">10</i>--%></b>
                                <span>${user.name}</span>
                                <p>安全等级：<i class="text-success">中</i></p>
                            </dd>
