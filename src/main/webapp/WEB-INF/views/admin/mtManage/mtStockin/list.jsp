...
<div id="editWin" class="easyui-dialog" data-options="title:'物料入库单',width:400,height:450,closed:true,modal:true">
    <form id="editForm" method="post">
        ...
        <table style="margin:auto" width="100%">
            ...
            <tr>
                ...
                <td><input id="remarks" type="text" name="remarks" class="easyui-textbox"
                           data-options="required:false,readonly:false,prompt:'备注说明',multiline:true,height:44"/></td>
            </tr>
            <tr>
                <td></td>
                <td>
